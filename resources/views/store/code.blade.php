...
@section('content')
    <div class="container mx-auto px-4 py-12">
        <div class="text-center mb-12">
            <h1 class="text-white font-montserrat font-bold text-3xl mb-2">THE CODE WHY WE EXIST</h1>
            <h2 class="text-white font-montserrat font-semibold text-xl">THE EVANOX MANIFESTO</h2>
        </div>
        ...
        <div class="text-center max-w-4xl mx-auto mb-16">
            ...
            <p class="text-white font-montserrat text-base mb-4">
