...
<div class="mb-16 flex justify-center -mt-10">
    ...
    <div class="text-center mb-16">
        <a href="{{ route('code') }}" class="inline-block">
            <div class="transition-transform duration-300 ease-in-out hover:-translate-y-1">
                <h1 class="text-white font-montserrat font-black text-6xl italic tracking-wider mb-4">ENTRER</h1>
            </div>
        </a>
        <p class="text-white font-montserrat text-xl">Enter The Archive</p>
    </div>
    ...
    <div class="text-center mb-6">
        <p class="text-white font-montserrat font-black text-xl mb-2">PRESSURE. VISION. LEGACY.</p>
        <p class="text-white font-montserrat font-bold text-lg">ONLY 100 LICENCE</p>
    </div>
