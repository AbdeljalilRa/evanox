...
<div class="min-h-screen bg-black text-white">
    <div class="px-7 md:px-12 py-10 md:py-16">
        ...
        <div class="text-center mb-6 md:mb-8">
            <h1 class="font-black uppercase text-[14px] md:text-[18px]" style="font-family: 'Montserrat', sans-serif;">
                About Us
            </h1>
            <p class="uppercase font-bold text-[12px] md:text-[19px] mt-1 tracking-[1.33px]" style="font-family: 'Montserrat', sans-serif;">
        ...
        <div class="flex justify-center mb-6 md:mb-8">
            <div class="w-[180px] h-[180px] md:w-[247px] md:h-[246px] rounded-full overflow-hidden">
        ...
        <!-- Name -->
        <div class="text-center mb-6 md:mb-8">
            <p class="uppercase font-bold text-[14px] md:text-[18px] tracking-[6.3px]" style="font-family: 'Montserrat', sans-serif;">
                SAAD KANI
            </p>
            <p class="uppercase font-bold text-[10px] md:text-[15px] mt-1 tracking-[1.65px]" style="font-family: 'Montserrat', sans-serif;">
                THE MAN BEHIND THE MARK
            </p>
        </div>

        <!-- Quote -->
        <div class="text-center max-w-[380px] md:max-w-[537px] mx-auto">
