...
@section('content')
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check">
                                                    <input class="form-check-input request-checkbox" type="checkbox"
                                                        value="{{ $req->id }}" {{ $req->password ? 'disabled' : '' }}>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    @if (!$req->password)
                                                        <form
                                                            action="{{ route('admin.access-requests.send-password', $req->id) }}"
                                                            method="POST" class="d-inline">
                                                            @csrf
                                                            <button type="submit" class="btn btn-soft-primary btn-sm"
                                                                data-bs-toggle="tooltip" title="Send Password">
    ...
    <!-- Bulk Action Form -->
    <form id="bulkActionForm" action="{{ route('admin.access-requests.bulk-send-password') }}" method="POST"
        class="d-none">
        @csrf
