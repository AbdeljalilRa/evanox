                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if ($category->image)
                                            <div class="mt-3">
                                                ...
                                                <img src="{{ asset('storage/categories/gallery/' . $category->image) }}"
                                                    width="150" class="rounded border" style="object-fit: cover;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-0">
                                        ...
                                        <textarea class="form-control bg-light-subtle @error('description') is-invalid @enderror" id="description"
                                            name="description" rows="4" placeholder="Type category description">{{ old('description', $category->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
